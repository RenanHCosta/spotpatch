...
create table public.projects (
  ...
  agent_mode text not null default 'approval_required' check (agent_mode in ('investigation_only','approval_required','autonomous_pr')),
...
create table public.feedback_items (
  ...
  status text not null default 'new' check (status in ('new','queued_for_investigation','investigating','needs_information','awaiting_approval','queued_for_execution','executing','pull_request_opened','completed','failed','rejected')),
