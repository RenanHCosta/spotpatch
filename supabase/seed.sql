...
values('11111111-1111-4111-8111-111111111111','Loja Demo SpotPatch','loja-demo','http://localhost:3000/demo','["localhost", "127.0.0.1"]','github','spotpatch-demo','storefront','main','approval_required',null,'smart',true)
